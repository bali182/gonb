...
export const hu: Messages = {
  ...
  PlayerTooltips: {
    ...
    MuteMelody: 'Dallam némítása',
    MuteChords: 'Kíséret némítása',
    MuteMetronome: 'Metronóm némítása',
    MaxMelody: 'Dallamot max hangerőre',
    MaxChords: 'Kíséretet max hangerőre',
    MaxMetronome: 'Metronómot max hangerőre',
    Play: 'Lejátszás',
    Pause: 'Szünet',
    Stop: 'Stop',
